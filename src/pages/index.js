...
const HomePage = ({ user, projects, experiences }) => {
  ...
  return (
    <>
      <Head>
        <title>Chandresh Sharma Portfolio</title>
        <link rel="icon" href="https://github.com/Chandresh-Sharma.png" />
        <meta name="description" content="Showcasing my GitHub-inspired portfolio. Explore my coding prowess and project highlights. Let's connect and collaborate on innovative ventures." />
        <meta
          name="keywords"
          content="chandresh sharma, chandresh, sharma, web developer, chandresh web developer, chandresh sharma web developer, chandresh portfolio, chandresh sharma portfolio, portfolio"
        />
        <meta property="og:title" content="Chandresh Sharma's Portfolio" />
        <meta
          property="og:description"
          content="Showcasing my GitHub-inspired portfolio. Explore my coding prowess and project highlights. Let's connect and collaborate on innovative ventures."
        />
        <meta property="og:image" content="https://i.imgur.com/1fn97U1.png" />
        <meta property="og:url" content="https://www.chandresh-sharma.com" />
        ...
        <meta name="twitter:domain" content="https://www.chandresh-sharma.com" />
        <meta name="twitter:url" content="https://www.chandresh-sharma.com" />
        ...
        <meta
          ...
          content="https://www.chandresh-sharma.com"
        ></meta>
      </Head>
...
export async function getStaticProps() {
  const userRes = await fetch(`https://api.github.com/users/Chandresh-Sharma`, {
